...
- Every run: `cd ~/anabtawi-company && git pull --rebase`, do your work, then `git add -A && git commit -m "finance: <date> run (grok-bot)" && git push`. Set `runtime: grok-bot` in your state file.
