...
---
## Headline
CA and US Account Health Rating GREAT (CA 212, US 200) with zero policy-violation counts; three CA parent listings remain suppressed for invalid condition type (age 5 days); CA late-shipping rate still FAIR. Real-time listing/account notification sources remain disabled in DataDoe, so coverage is export-only.

## Data
### Account status (DataDoe export `6ed7d913-253a-45bd-a6f6-aa619a37f4c3`, Seller Account Health Metrics, window 2026-09-01→2026-09-09; latest rows dated 2026-09-06)
...
### Listing status summary (DataDoe export `fcc3c1c2-c1f6-4352-9bf7-9f7afcda840a`, Listings, 39 rows)
...
### Open listing issues with Amazon enforcement (DataDoe export `9e43d2da-2e37-4e1d-b940-94f0ece5825b`, Listings Raw JSON; compared to state/health.md 2026-09-08)
| sku | asin | marketplace | status | issue | enforcement | age_days |
|---|---|---|---|---|---|---|
| Holy-Land-Cookies-Parent | B0GKGW6DJ7 | ca | Incomplete | code 8115 invalid condition type | LISTING_SUPPRESSED | 5 (first seen 2026-09-04) |
| Premium-Baklava-Gift-Parent | B0GKGQ15SQ | ca | Incomplete | code 8115 invalid condition type; code 18367 product_type PASTRY→FOOD note | LISTING_SUPPRESSED | 5 (first seen 2026-09-04) |
| Holy-Land-Baklava-Gift-Parent | B0GKH8YNXP | ca | Incomplete | code 8115 invalid condition type; code 18367 product_type PASTRY→FOOD note | LISTING_SUPPRESSED | 5 (first seen 2026-09-04) |
...
## Exceptions
- CA `seller_late_shipping_rate_30d_status` = FAIR (export `6ed7d913…`, unchanged vs 2026-09-08). Watch; not a compliance-hold.
...
- Metrics export latest date is 2026-09-06 (no 2026-09-07, 2026-09-08, or 2026-09-09 row yet in window).
- Active SKU FBA available qtys unchanged vs 2026-09-08: `OA-26MX-IHV0`=45, `26-JITG-E4FU`=19, `0C-45D7-6JUB`=1.

## Requests sent
- none new this run (open hold already with catalog: 20260904-0626-account-health-compliance-hold; ## Update 2026-09-09 appended)
