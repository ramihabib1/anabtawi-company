...
Serious operators — aggregators, agencies, and Amazon itself — all run the same three-layer rhythm: a **daily exception scan** (minutes, alarm-driven), a **weekly business review** (the real decision meeting), and a **monthly/quarterly plan-and-falsify cycle**.
...
Agency SOP libraries run the same shape smaller — a PPC SOP with daily budget checks (5–10 min), weekly search-term optimisation (30–45 min), monthly strategy review (1–2 hrs), each SOP with a named owner and quarterly review [REPORTED — https://taskip.net/how-to-create-agency-sops/ ; https://myamazonguy.com/sop/amazon-sop-library/].

Aggregators (Thrasio-style) used standardised relaunch playbooks — PPC, listing, supply chain, expansion — applied uniformly across a portfolio [REPORTED — https://teardowns.sandhill.io/p/thrasio]. Their failure is instructive: the autopsies blame over-standardisation and headcount ("teams of ten doing the work of two") and the assumption that all FBA assets behave alike, not the cadence [REPORTED — https://www.marketplacepulse.com/articles/death-by-valuation-the-amazon-aggregator-autopsy ; https://restructuringnewsletter.com/p/trash-io-the-stumble-from-scale-and-short-term-solutions]. **Copy the cadence, not the headcount. The cadence is the part that automates.**
...
- **TACoS** — total ad spend ÷ total revenue. The composite health number. An established brand with real organic share typically sits ~10–15% TACoS; brand-defence campaigns run leaner (5–10% ACoS), category-conquest can justify 25–40% ACoS if those buyers repeat [REPORTED — https://canopymanagement.com/ultimate-guide-to-acos-and-tacos/ ; https://www.velocitysellers.com/2026/04/19/tacos-ceiling-amazon-ad-spend-data/]. The better sources argue against benchmark-chasing: derive the target from unit economics — *if gross margin is 40% and you need 15% after ads, target ACoS is 25%* [REPORTED — https://marketplacevalet.com/how-to-set-tacos-targets-by-product-lifecycle-and-contribution-margin/].
- **Contribution margin per unit** — revenue − COGS − FBA fulfilment − referral − storage/other variable − ads. Audited brands commonly land at 12–22% once everything is counted [REPORTED — https://www.brandgrowthiq.com/blog/amazon-profitability-playbook/]. This is the number the AGENTS.md 15% floor should be measured against, and it must include the 2026 fee lines below or it lies.
...
- Bilingual (English + French) labelling is mandatory for all required information: common name, net quantity, ingredient list, allergen declarations, Nutrition Facts table, country of origin, and the name and address of the responsible Canadian party [REPORTED — https://www.nexreg.com/canadian-food-labelling-requirements-guide ; https://businesscentralconsultants.com/blog/bilingual-labelling-compliance-sfcr-canadian-food-manufacturers/].
- The Nutrition Facts table must use Health Canada's prescribed bilingual format.
- **Front-of-package (FOP) nutrition symbol:** the transition period ended 31 December 2025; from **1 January 2026** all labels must comply, with the FOP symbol required where saturated fat, sugars, or sodium reach ≥15% DV [REPORTED — https://www.nsf.org/ca/en/knowledge-library/calling-canadas-food-businesses-ready-labelling-changes ; https://qualitysmartsolutions.com/services/canada-food-label-french-translation/]. **This is live now and applies to Anabtawi's existing Canadian catalogue.** Halva, date syrup, tahini and similar products very plausibly cross the saturated-fat or sugars thresholds.
- Importing food into Canada requires an SFC (Safe Food for Canadians) licence and CFIA/CBSA compliance [REPORTED — https://jwsmith.com/guides/how-to-import-food-into-canada].

### 4.5 United States — FDA, FSVP, prior notice

- **FSVP:** the importer of an imported food is responsible for verifying the foreign supplier. If you list imported food on Amazon US you are treated as the importer and the full FSVP obligation attaches. A foreign brand selling into the US must appoint a **US-based FSVP agent** [REPORTED — https://qualitysmartsolutions.com/blog/what-amazon-usa-sellers-need-to-know-about-fsvp-compliance ; https://globalimportagent.com/fsvp-amazon-fda-agent-gad01/].
- **Prior Notice:** food shipments require an FDA Prior Notice confirmation number; without it, cargo is held and detained. FDA facility registration numbers feed the customs/PN process [REPORTED — https://www.fda.itbhdg.com/blog/fulfillment-by-amazon-fba/ ; https://www.fdaregistrationassistance.com/fda-compliance-for-amazon-food-sellers/].
- **Amazon will not act as importer of record for FBA inventory** — any shipment, any size, any origin. The Canadian entity must register as US IOR (CBP Form 5106) and post a customs bond, carrying full liability for classification and entry [REPORTED — https://carraglobe.com/importer-of-record-amazon-fba/ ; https://myamazonguy.com/amazon-canada/selling-on-amazon-usa-from-canada/].
- **Hazmat:** UNKNOWN in detail. I could not confirm which, if any, Anabtawi SKUs would be flagged (aerosols, alcohol-containing extracts, and some pressurised or flammable items are the usual triggers). Amazon runs a dangerous-goods review on new ASINs. Needs a per-SKU check at listing time.

### 4.6 Bundles and multi-packs

Since **14 October 2024**, consumables bundles may only be listed if created and offered by the original manufacturer, who must be the brand owner of every item in the bundle. Mixed-manufacturer bundles, "Generic"-brand bundles, and reseller-created bundles are no longer permitted in grocery, pet, baby, and health & beauty [REPORTED — https://myfbaprep.com/blog/amazon/navigating-amazons-new-consumables-bundling-policy/ ; https://alpharepricer.com/blogs/amazon-fba-bundling-compliance-packaging-buy-box/]. Because Anabtawi is the brand owner across its own SKUs, **brand-owner multi-packs and gift sets remain available** — and they are the cleanest lever for raising average order value into Ramadan without touching unit price. Virtual Bundles are a lower-risk alternative for cross-SKU sets.
