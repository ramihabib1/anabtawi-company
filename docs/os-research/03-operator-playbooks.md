...
3. **Promote Supply Chain toward T1 before Advertising.** The constitution gives Advertising the only T1 class, but §7's fee corridor is where money silently leaks and where the rules are cleanest. Give Supply Chain T1 monitoring-and-escalation now; ratchet reorder-point recalculation and removal recommendations next.
...
6. **Without the 2026 fee lines, the 15% contribution-margin floor is fiction.** Low-inventory-level fee, storage-utilisation and aged-inventory surcharges, inbound placement, the 3.5% Canadian fuel surcharge, and the end of Amazon prep (US Jan 2026, Canada Jul 2026) all sit between gross and contribution margin. Every one needs a named line in Finance's SKU model.
