---
id: 20260914-supply-chain-po-TB-PIST-120
...
Cover before 15.0 days (fulfillable 0, inbound 30, status watch) — state/inventory.md 2026-09-14. Velocity 2.0000/day (vel_denom 15) from DataDoe shipped orders job 5a4823aa-7eff-44f4-88fb-2ef4b55f4916. Target units 84.0; ROP 56.0 using ASSUMED lead 21 from suppliers/anabtawi.md TBD. Unit cost: null CAD (median cogs_item_value/qty from CA shipped orders export; null if missing/zero). need-cash-check filed: requests/finance/inbox/20260914-0610-supply-chain-need-cash-check.md (unanswered at write).
...
Hero remains under target cover; estimated lost sales continue ~CAD 25.98/day while fulfillable=0. Keep advertising throttled via stockout-risk. Re-propose next Monday with fresh velocity and Freightos quote.
